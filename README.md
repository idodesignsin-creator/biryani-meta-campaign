...
| [`campaign/exact-not-showing-2026-09-01.md`](campaign/exact-not-showing-2026-09-01.md) | **"The ad isn't showing"** — it is, at the bottom; 8 of 10 bids sit below the suggested range, and why raising them is the wrong fix |
| [`campaign/cardamom-8mm-listing.md`](campaign/cardamom-8mm-listing.md) | **Cardamom 8mm++ "Diamond" listing copy** — title, item highlight, bullets, backend for the Aug 2026 harvest |
